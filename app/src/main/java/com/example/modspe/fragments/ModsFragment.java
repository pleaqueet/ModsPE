...
import com.example.modspe.adapters.ModsAdapter;
...
public class ModsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_mods, null);
        ...
        RecyclerView recView = root.findViewById(R.id.recyclerViewMods);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recView.setLayoutManager(layoutManager);
        ModsAdapter adapter = new ModsAdapter(getContext(), items);
        ...
        recView.scrollToPosition(lastposition);
